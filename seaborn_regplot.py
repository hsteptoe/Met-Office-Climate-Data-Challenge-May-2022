...
# Spring plots
df_crime_climate['month_name'] = df_crime_climate.index
df_crime_climate['month_name']  = pd.to_datetime(df_crime_climate['month_name'], format="%Y-%m-%d").dt.strftime("%b")
df_crime_climate_spring = df_crime_climate[(df_crime_climate['month_name']=='Mar') | (df_crime_climate['month_name']=='Apr') | (df_crime_climate['month_name']=='May')]

for crime_type in crime_types:
    for climate_type in climate_types:
        filename = output_location + 'plots/regplots/spring/' + crime_type + '_' + climate_type + '.png'

        sns.regplot(x=crime_type, y=climate_type, data=df_crime_climate_spring, logx=True)
        plt.savefig(filename)
        plt.close()


# Summer plots
df_crime_climate_summer = df_crime_climate[(df_crime_climate['month_name']=='Jun') | (df_crime_climate['month_name']=='Jul') | (df_crime_climate['month_name']=='Aug')]

for crime_type in crime_types:
    for climate_type in climate_types:
        filename = output_location + 'plots/regplots/summer/' + crime_type + '_' + climate_type + '.png'

        sns.regplot(x=crime_type, y=climate_type, data=df_crime_climate_summer, logx=True)
        plt.savefig(filename)
        plt.close()


# Autumn plots
df_crime_climate_autumn = df_crime_climate[(df_crime_climate['month_name']=='Sep') | (df_crime_climate['month_name']=='Oct') | (df_crime_climate['month_name']=='Nov')]

for crime_type in crime_types:
    for climate_type in climate_types:
        filename = output_location + 'plots/regplots/autumn/' + crime_type + '_' + climate_type + '.png'

        sns.regplot(x=crime_type, y=climate_type, data=df_crime_climate_autumn, logx=True)
        plt.savefig(filename)
        plt.close()


# Winter plots
df_crime_climate_winter = df_crime_climate[(df_crime_climate['month_name']=='Dec') | (df_crime_climate['month_name']=='Jan') | (df_crime_climate['month_name']=='Feb')]

for crime_type in crime_types:
    for climate_type in climate_types:
        filename = output_location + 'plots/regplots/winter/' + crime_type + '_' + climate_type + '.png'

        sns.regplot(x=crime_type, y=climate_type, data=df_crime_climate_winter, logx=True)
        plt.savefig(filename)
        plt.close()
